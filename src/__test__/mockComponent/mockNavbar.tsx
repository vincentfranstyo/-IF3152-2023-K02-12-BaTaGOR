...
import NavButtonSignout from "../../components/NavButtonSignout"

const Navbar = ({userState}: {userState: Boolean}) => {
  return (
    <nav className="flex-between w-full mb-16 pt-4">
			...
			<div className="sm:flex hidden">
				{userState ? ( // If the user is logged in, show the option to check their history, sign out, and 
					<div className="flex-between gap-4 md:gap-8">
						...
						<Link href="/history" className="blue_btn_2" data-testid="checkButton"> History </Link>	
            	...
            	Register
						...
						<Link href="/auth/SignIn" className="blue_btn_2" data-testid="checkButton">
            	Sign In
          	</Link>
