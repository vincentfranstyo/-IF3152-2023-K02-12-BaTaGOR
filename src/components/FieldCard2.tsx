...
const FieldCard2 = ({image, name, address, distance, rating, price}: {
    image: string,
    name: String,
    address: String,
    distance: number,
        ...
        <div className="card_container">
            ...
            <div className="card_details">
                <div className="card_slot lg:visible">
                    <Image src="/assets/icons/location_pin.png" alt="Distance" width={30} height={30}
                           className="card_icon"/>
                    <p className="card_subtext">{distance} KM</p>
                </div>
                <div className="card_slot lg:visible">
                    <Image src="/assets/icons/star_icon.webp" alt="Rating" width={30} height={30}
                           className="card_icon"/>
                    <p className="card_subtext">{rating}/5.0 </p>
                </div>
                <div className="card_slot lg:visible">
                    <Image src="/assets/icons/price_label.png" alt="Price" width={30} height={30}
                           className="card_icon"/>
